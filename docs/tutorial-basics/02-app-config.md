...
How to use this config ? Here is a tutorial wrote by yixiu:

[A Comprehensive Guide to Managing Environment Configurations in JoyID-based CKB Applications (by yixiu)](https://talk.nervos.org/t/a-comprehensive-guide-to-managing-environment-configurations-in-joyid-based-ckb-applications/7539)